...
while True: 
    Ms = me.Ms(((10 ** rand_gen.uniform(np.log10(0.1), np.log10(5))) * u.T).to("A/m"))  # 0.1 - 5 T (log10-uniform)
    A  = me.A(10 ** rand_gen.uniform(np.log10(1e-13), np.log10(1e-11)), unit="J/m")     # 1e-13 - 1e-11 J/m (log10-uniform)
    K1 = me.Ku(10 ** rand_gen.uniform(np.log10(10e3), np.log10(10e6)), unit="J/m3")     # 10e3 - 10e6 J/m3 (log10-uniform)
